...
The "Add habit" header button fades to 40% opacity while the form is open.
...
- "Add habit" header button is disabled, border and text change to #b8d4f0
- Existing habit cards dim to 45% opacity to reinforce the page is in a busy state